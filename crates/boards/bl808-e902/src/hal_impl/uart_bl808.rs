...
impl Bl808Uart {
    ...
    fn configure_clock(&self) {
        ...
        // Select the 40 MHz crystal as MCU XCLK and UART clock source.
    ...
    fn configure_gpio(&self, pin: u8) {
        // GPIO alternate function 7 is the MCU UART pad function.
...
impl SerialPort for Bl808Uart {
    fn init(&self) {
        ...
        // 8 data bits, no parity, one stop bit, matching the SDK config.
        ...
        // Start with all UART interrupt sources masked.
